...
largura = float(largura)      #Converte para decimal em caso de número quebrado
altura = float(altura)        #Converte para decimal em caso de número quebrado

area=(altura * largura)    #Calcula área total da parede

totaltinta=(area/2)     #Calcula quantidade de tinta necessária com o valor fixo 
