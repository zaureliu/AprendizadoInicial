...
raiz=(numero ** 0.5)      #Elevar a 0.5 calcula a raiz quadrada; use um número não negativo.

print('O dobro do numero é {}, o seu triplo é: {} e sua raiz quadrada é: {}. '.format(dobro,triplo,raiz))      #Mostra na tela o resultado.
